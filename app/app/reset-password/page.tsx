        ...
        <div style={{ width:'100%', maxWidth:400 }}>
          ...
          {stage==='done' && (
            <div style={{ textAlign:'center' }}>
              ...
              <p style={{ fontSize:'0.85rem', color:'#7eabc5', lineHeight:1.6, marginBottom:24 }}>We sent a reset link to <strong style={{ color:'white' }}>{email}</strong>. Click it to set a new password.</p>
